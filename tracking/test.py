...
def main():
    ...
    parser.add_argument('--tracker_name', default="mvit", type=str, help='Name of tracking method.')
    parser.add_argument('--tracker_param', default="baseline_256_4", type=str, help='Name of config file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default='otb99', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
